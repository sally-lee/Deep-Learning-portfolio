...
if __name__ == '__main__':
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=args.save_dir, filename='{epoch}-{val_loss:.3f}-{train_loss:.3f}',
                                          save_top_k=-1)
    logger = CometLogger(
    ...
    trainer = pl.Trainer(gpus=args.gpus, logger=logger, accelerator="cuda",max_epochs=args.epochs,
                         default_root_dir=args.save_dir,  auto_lr_find=True,
