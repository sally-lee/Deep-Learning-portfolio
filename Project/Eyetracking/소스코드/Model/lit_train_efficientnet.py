...
from lit_efficientnet import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_efficientnet_2/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-efficientnet-2', help='Path store checkpoints')
